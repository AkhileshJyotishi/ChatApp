                        ...
                        <div className='flex flex-col h-full bg-teal-50'>
                            {
                                activeFriend !== null ?
                                    <>
                                        ...
                                        {/* Chat */}
                                        <div className='flex-grow overflow-y-auto py-4 flex-col-reverse flex'>
                                            {
                                        ...
                                        <div className='flex items-center bg-blue-300'>
                                            <input type="text" className='flex-grow border-none rounded outline-none' placeholder='Type a message' id='sendMessage' />
                                            ...
                                            onClick={()=>{
                                                const sendMessageInput = document.getElementById('sendMessage') as HTMLInputElement;
                                                setMessageArray(prevarr=>{
                                                    return(
                                                        [{owner:true,messageText:sendMessageInput.value,timeStamp:'3pm'},...prevarr]
                                                    )
                                                })
